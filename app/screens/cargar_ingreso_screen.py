...
class CargarIngresoScreen(Screen):
    def __init__(self, **kwargs):
        ...
        titulo = Label(text="Cargar ingreso", font_size=32, size_hint_y=None, height=56)
        style_title(titulo)
        ...
        boton_guardar = Button(text="Guardar ingreso", size_hint_y=None, height=48)
        style_primary_button(boton_guardar)
        boton_guardar.bind(on_release=self.guardar_ingreso)
    ...
    def _cargar_opciones(self):
        categorias = self._categoria_service.listar_por_tipo(TipoMovimiento.INGRESO)
    ...
    def guardar_ingreso(self, _instance):
        ...
        self.mensaje_label.text = "Ingreso guardado correctamente"
